...
if("FALSE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/robond/catkin_ws/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/robond/catkin_ws/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/robond/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/catkin_ws/install/${idir}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
    endif()
